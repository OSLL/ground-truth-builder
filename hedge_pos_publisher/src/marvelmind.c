...
#include <pthread.h>
#endif // WIN32
#include "hedge_pos_publisher/marvelmind.h"
...
{
    struct MarvelmindHedge * hedge = (MarvelmindHedge *)malloc (sizeof (struct MarvelmindHedge));
    if (hedge)
    {
...
void startMarvelmindHedge (struct MarvelmindHedge * hedge)
{
    ...
    hedge->positionBuffer= (PositionValue *)
